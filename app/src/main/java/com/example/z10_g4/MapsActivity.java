...
import com.example.z10_g4.databinding.ActivityMapsBinding;
    ...
    void getLocation(){
        fusedLocationProviderClient.getLastLocation().addOnSuccessListener(this, new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                ...
                //pongamole un marcador
                mMap.addMarker(new MarkerOptions().position(mylocation).title("Mi localizacion"));
